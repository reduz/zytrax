#ifndef EFFECT_AMPLIFIER_H
#define EFFECT_AMPLIFIER_H

#include "engine/audio_effect.h"

class AudioEffectAmplifier : public AudioEffect {

	enum ControlPorts {
		CONTROL_PORT_AMPLIFY_DB,
		CONTROL_PORT_MAX
	};
...
public:
	...
	AudioEffectAmplifier();
	~AudioEffectAmplifier();
};

#endif // EFFECT_AMPLIFIER_H
